...
// ====== PID VARIABLES ======
float Kp = 550;        // main control
float Ki = 0.0;         // optional
float KpCorner = 0.35;  // slightly stronger turning at corners
float Kd = 1.0;

float lastError = 0;
float integral = 0;

int baseSpeed = 170;   // NORMAL speed
int maxSpeed = 220;    // limit

// ====== IR Calibration ======
int L_min = 60, L_max = 420;//int L_min = 170, L_max = 660;
int R_min = 55, R_max = 510;//int R_min = 80, R_max = 525;
